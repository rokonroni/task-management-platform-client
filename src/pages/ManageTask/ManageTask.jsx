    ...
    <div className="max-h-screen">
      ...
      <div className="flex  flex-col md:flex-row ">
        <div className="flex-1 w-full min-h-max ">
          <h1 className="text-center text-2xl py-4 ">Todo List</h1>
          <div className=" flex flex-col gap-2 m-4 bg-gray-100 shadow-lg rounded-xl">
            <div className="collapse collapse-plus ">
              ...
              <div className="flex justify-center text-xl w-max-fit gap-4 px-8 mb-4 ">
                <button className="btn btn-active bg-gradient-to-r hover:bg-gradient-to-l from-sky-600 to-cyan-400 px-4  py-2 w-1/2 rounded-lg text-white">
                 Update Task
                </button>
        ...
        <div className=" bg-slate-400 w-full flex-1 flex-col">
          <div className="min-h-[50%]">ongoing</div>
          <div className="min-h-[50%]">completed</div>
        </div>
      </div>
    </div>
  );
